package com.petrenko.lab0302.framework;
...
public abstract class State {
	...
	// Інтерфейс для єкстендед класів
	...
	protected void startPrint() {
		// очистка екрану (потрібна підтримка ANSI escape codes)
	    System.out.print(ConsoleExtras.ANSI_CLEAR);  
	    System.out.flush();  
	    
	    System.out.println("    Online Shop App");
	    printSeparator();
		options.clear();
	}
